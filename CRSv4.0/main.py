...
from exception.myexceptions import CustomerNotFoundException, VehicleNotFoundException
...
class CarRentalSystem:
    ...
    def list_customers(car_lease_repository):
        try:
            ...
            if customers:
                ...
                rows = [list(customer.values()) for customer in customers]
    ...
    def calculate_total_revenue(car_lease_repository):
        try:
            ...
            print(
                tabulate(
                    [[f"Total Revenue: {total_revenue}"]], tablefmt="simple_outline"
                )
            )
    ...
    def list_all_payments(car_lease_repository):
        try:
            ...
            if payments:
                ...
                rows = [list(payment.values()) for payment in payments]
                print(tabulate(rows, headers=headers, tablefmt="simple_outline"))
            else:
